...
class _AnswersPageState extends State<Answers> {
  ...
  String selectedAnswer = '5%';
  String correctAnswer='240%';
  String explanation='50 .x = 120\n=> x = 2.4\n=> 2.4 expressed as percent\nis 240 % .';
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildBottomBox(screenHeight, screenWidth, numberOfQuestions,selectedAnswer,correctAnswer,explanation),
    ...
    child: Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          _buildAnswerBox(selectedAnswer,Colors.white,Color(0xFFE33629),screenWidth),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.start, // Align to the start (left)
            children: [
          ...
          SizedBox(height: 20),
         _buildAnswerBox(correctAnswer, Color(0xFF53DF83),Color(0xFF53DF83), screenWidth),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.start, // Align to the start (left)
            children: [
...
Widget _buildAnswerBox(String answer, Color color1, Color color2, double screenWidth) {
  Color textColor = color2 == Color(0xFFE33629) ? color2 : Colors.white;
  String imagePath = (color2 == Color(0xFFE33629)) ? 'images/no.png' : 'images/tick.png';
